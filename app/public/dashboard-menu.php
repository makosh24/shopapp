...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-title" align="center">
					<h1 class="pmd-card-title-text typo-fill-secondary propeller-title">НАСТРОЙКИ</h1>
				</div>
				<div class="pmd-card-body" align="center">
					<table class="table pmd-table" id="table-propeller">
						...
						<tr>
							<td>Администратор</td>
							<td>:</td>
							<td><a href="edit-profile.php?id=<?php echo $data['id']; ?>">Редак...</a></td>
						</tr>
					</table>
				</div>
			</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
			<div class="pmd-card pmd-z-depth">
				<div class="pmd-card-title" align="center">
					<h1 class="pmd-card-title-text typo-fill-secondary propeller-title">ПОДДЕРЖИ ПРОЕКТ</h1>
				</div>
				<div class="pmd-card-body" align="center">
					<p>Ваша помощь для новых уроков</p>
					<br>
					<p><a href="#" target="_blank">ПОЖЕРТВОВАТЬ</a></p>
					<br>
					<p>medenbai@gmail.com</p>
				</div>
			</div>
		</div>
