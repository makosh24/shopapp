        ...
        <div class="login-card">
            <form method="POST">  
                ...
                <div class="pmd-card-footer card-footer-no-border card-footer-p16 text-center">
                    ...
                    <br>
                    <br>
                    <span class="pmd-card-subtitle-text">Madi Yedenbay &copy; <span class="auto-update-year"></span>. All Rights Reserved.</span>
            <h3 class="pmd-card-subtitle-text"><a href="#" target="_blank"> Версия 2.1</a></h3>
